        ...
        <Tabs className="flex flex-col px-4">
          <TabList>
            <div className="flex flex-row">
              ...
              <Tab>
                <button className="font-normal px-8 py-2 mr-3 text-theme-purple text-lg border border-theme-purple rounded-full transition duration-300 hover:bg-theme-purple hover:text-white focus:outline-none focus:bg-theme-purple focus:text-white">UI/UX</button>
              </Tab>
            </div>
          </TabList>
                    ...
                    <Button type="link" href={`/project/${item.id}`}>
                      <div className="group rounded-2xl shadow-xl w-auto w-11/12 m-3 transform transition duration-500 hover:scale-110 portofolio-card">
                        <div className="relative">
                          <img src={item.src} alt="Portfolio" className="rounded-t-2xl z-0" />
